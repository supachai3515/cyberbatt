...
<html lang="">
	<head>
		...
		<title>ใบเสนอราคา <?php echo $orders_data['invoice_docno']." ".$orders_data["name"];?></title>
	...
	<div class="container fix-container" ng-init="orderSenmailInit()">
		<div class="row">
            	...
            	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                        ...
                        <?php endif ?>
        				 <?php echo  $quotation_data['docno'];?> </h3>
                        <strong>วันที่ออก <?php echo date("Y-m-d", strtotime($quotation_data['create_date']));?></strong><br/>
                        <strong>วันครบกำหนด <?php echo date("Y-m-d", strtotime($quotation_data['due_date']));?></strong><br/>
		...
		<div class="col-xs-6">
			...
			<p class="text-center">ผู้เสนอราคา</p>
		...
		<div class="row noprint">
			...
			<a class="btn btn-default btn-sm" href="<?php echo base_url("quotation/quotation_invoice_searial/".$quotation_data['id']."/1");?>" role="button">สำเนา</a> 
			<a class="btn btn-default btn-sm" href="<?php echo base_url("quotation/quotation_invoice_searial/".$quotation_data['id']);?>" role="button">ต้นฉบับ</a> 
			<br><br>
			...
			<a class="btn btn-success" href="<?php echo base_url("quotation");?>" role="button">ปิดหน้าต่างนี้</a>
			</p>
		</div>
	</div>
