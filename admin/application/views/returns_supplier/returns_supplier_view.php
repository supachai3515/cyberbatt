<div class="content-wrapper">
  ...
  <div class="container-fluid box" ng-controller="returns_supplier">
    <div class="page-header">
      <h2>ใบรับคืน <?php echo $returns_supplier_data['docno']; ?></h2>
    </div>
    ...
    <form class="form-horizontal">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-1">
            <input type="text" name="docno" hidden="true" value="<?php echo $returns_supplier_data['docno']; ?>">
            <input id="id" name="id" type="text" readonly="true" value="<?php echo $returns_supplier_data['id']; ?>" placeholder="รหัส" class="form-control input-md" required="">
          </div>
          <label class="col-md-3">
            <?php echo $returns_supplier_data['docno']; ?>
          </label>
        </div>
        ...
        <div class="form-group">
          ...
          <label class="col-md-3">
            <?php echo $returns_supplier_data['invoice_no']; ?>
          </label>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            ...
            <p><strong>Product Name: </strong>
              <?php echo $returns_supplier_data['product_name']; ?>
                <br>
                <strong>Price : </strong>
                <?php echo $returns_supplier_data['price']; ?>
            </p>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <select id="select_return_type" name="select_return_type" class="form-control" readonly>
             <?php if ($returns_supplier_data['return_type_id']== 0 || !isset($returns_supplier_data['return_type_id'])): ?>
                <option value="0" selected>*** ไม่มี ***</option>
                <?php else: ?>
                  <option value="0">*** ไม่มี ***</option>
            <?php endif ?>
          <?php foreach ($return_type_list as $return_type): ?>
              <?php if ($return_type['id']==$returns_supplier_data['return_type_id']): ?>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <textarea class="form-control" name="comment" readonly><?php echo $returns_supplier_data['comment']; ?></textarea>
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-3 control-label" for="issues_comment">ปัญหาที่เสีย</label>
          <div class="col-md-6">
            <textarea class="form-control" name="issues_comment" readonly><?php echo $returns_supplier_data['issues_comment']; ?></textarea>
          </div>
        </div>
        <?php if ($returns_supplier_data['is_cut_stock']==1): ?>
          ...
          <?php endif ?>
              ...
              <div class="col-md-4">
                <div class="checkbox">
                  <label for="is_cut_stock-0">
                    <input type="checkbox"  name="is_cut_stock" id="is_cut_stock-0" value="1" <?php if ($returns_supplier_data[ 'is_cut_stock']==1): ?>
                    <?php echo "checked"; ?>
              ...
              <div class="col-md-4">
                <div class="checkbox">
                  <label for="isactive-0">
                    <input type="checkbox"  disabled="true" name="is_active" id="isactive-0" value="1" <?php if ($returns_supplier_data[ 'is_active']==1): ?>
                    <?php echo "checked"; ?>
                      <?php endif ?>
                        > ใช้งาน
                  </label>
            ...
            <?php if (isset($returns_supplier_data['credit_note_docno']) || isset($returns_supplier_data['delivery_return_docno'])): ?>
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="alert alert-danger">
                    ...
                    <strong></strong>
                    <?php if (isset($returns_supplier_data['credit_note_docno'])): ?>
                      ใบลดนี้เลขที่ #
                      <?php echo $returns_supplier_data['credit_note_docno'] ?>
                        <?php else: ?>
                          ใบส่งคืนเลขที่ #
                          <?php echo $returns_supplier_data['delivery_return_docno'] ?>
                            <?php endif ?>
                  </div>
                </div>
              </div>
