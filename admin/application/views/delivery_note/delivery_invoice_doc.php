...
<html lang="">
	...
	<div class="container fix-container" ng-init="orderSenmailInit()">
		...
		<div class="row noprint">
			...
			<a class="btn btn-default btn-sm" href="<?php echo base_url("delivery_note/delivery_invoice/".$delivery_note_data['id']."/1");?>" role="button">สำเนา</a> 
			<a class="btn btn-default btn-sm" href="<?php echo base_url("delivery_note/delivery_invoice/".$delivery_note_data['id']);?>" role="button">ต้นฉบับ</a> 
			<br><br>
