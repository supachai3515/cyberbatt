    ...
    <div class="container-fluid box" ng-controller="mainCtrl">
        ...
        <div role="tabpanel">
            <!-- Nav tabs -->
             <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                    <a href="#add" aria-controls="tab" role="add" data-toggle="tab"><i class="fa fa-plus"></i> Export</a>
                </li>
            </ul>
            <div class="tab-content">
                ...
                <div style="padding-top:30px;"></div>
                <form action="<?php echo base_url('members/export');?>" method="POST" class="form-inline" role="form">
