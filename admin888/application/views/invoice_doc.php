		...
		<div class="row">
            	...
            	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
        			<?php if ($orders_data['is_invoice'] == 1): ?>
        				<h3>ใบกํากับภาษี/ใบเสร็จรับเงิน <?php echo  $orders_data['invoice_docno'];?> </h3>
                        <strong>วันที่ออก <?php echo $orders_data['invoice_date']?></strong><br/>
                    <?php else: ?>
                       <h2>เลขที่ใบสั่งซื้อ #<?php echo  $orders_data['id'];?> </h2>
                       <strong>วันที่ออก <?php echo $orders_data['date']?></strong><br/>
                    <?php endif ?>
	                            ...
	                            <?php endforeach ?>
								  ...
								  <tr>
	                                ...
	                                <tr>
	                                    ...
	                                    <td class="emptyrow text-right"><?php echo number_format($orders_data["vat"],2)."&nbsp;บาท"; ?></td>
	                                </tr>
	                                 <tr>
	                                 	<td class="emptyrow"></td>
	                                    <td class="emptyrow"></td>
	    ...
	    <div class="row">
	    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	    		...
	    		<div class="panel-body">
	    		   ...
	    		   <input type="checkbox" value=""> เงินสด <input type="checkbox" name=""> เช็ค <input type="checkbox" name="" checked> โอนเงิน 
	    		   <input type="checkbox" name=""> บัตรเครดิต
	    		   </p>
	    		   <p>ธนาคาร <u><?php echo $orders_data['bank_name'];?></u> วันที่ <u><?php echo $orders_data['inform_date'];?></u>  จำนวนเงิน <u><?php echo number_format($orders_data['amount'],2);?></u> </p>
	    		  <div class="row">
	    		  	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
	    		  		<br>
	    		  		<br>
	    		  	...
	    		  	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
	    		  		<p class="text-center">ในนาม บริษัท ไซเบอร์ทูฟิกซ์ จำกัด</p>
	    		  		<br>
	    		  		<br>
	    		  		<br>
	    		  		<div class="row">
