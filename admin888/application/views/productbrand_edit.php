  ...
  <section class="content">
    <div class="container-fluid box" ng-controller="myCtrl">
        <div class="page-header">
          <h1>แก้ไขยี่ห้อสินค้า</h1>
        </div>
        <div style="padding-top:30px;"></div>
        <form class="form-horizontal" method="POST"  action="<?php echo base_url('productbrand/update/'.$productbrand_data['id']);?>" accept-charset="utf-8" enctype="multipart/form-data">
        <fieldset>
        <!-- Text input-->
        <div class="form-group">
          <label class="col-md-3 control-label" for="id">รหัส</label>  
          <div class="col-md-4">
          <input id="id" name="id" type="text" disabled="true" value="<?php echo $productbrand_data['id']; ?>" placeholder="รหัส" class="form-control input-md" required="">
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">                     
            <textarea class="form-control" id="detail" name="description"><?php echo $productbrand_data['description']; ?></textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="checkbox">
            <label for="isactive-0">
              ...
              <?php if ($productbrand_data['is_active']==1): ?>
                <?php echo "checked"; ?>
              <?php endif ?>
              >
              ใช้งาน
